<?php
    ...
    if(checkForRights($loggedUserId, $editUserId)){
...
<body>
    ...
    <main id="js-page-content" role="main" class="page-content mt-3">
        ...
        <?php displayFlashMessage('danger');?>
        ...
        <form action="handler_security.php?id=<?=$editUserId;?>" method="POST">
            <div class="row">
                <div class="col-xl-6">
                        ...
                        <div class="panel-container">
                            ...
                            <div class="panel-content">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" name="pwd" id="simpleinput" class="form-control">
                                </div>

                                <!-- password confirmation-->
                                <div class="form-group">
                                    <label class="form-label" for="simpleinput">Подтверждение пароля</label>
                                    <input type="password" name="conf_pwd" id="simpleinput" class="form-control">
                                </div>
